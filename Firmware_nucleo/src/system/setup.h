...
#define LINE_ADC_INPUT4		PAL_LINE(GPIOA,6)	// BattCurrV
...
#define NUCLEO_BUTTON		PAL_LINE(GPIOC,13)

//#define LINE_LED_GREEN 		PAL_LINE(GPIOC,10)
//#define LINE_LED_YELLOW 	PAL_LINE(GPIOC,11)
////real LED (green)
//#define LINE_LED_BLUE 		PAL_LINE(GPIOA,5)	//PAL_LINE(GPIOC,12)
...
// UART UART2
#define LINE_UART2_TX		PAL_LINE(GPIOA,2)
#define LINE_UART2_RX		PAL_LINE(GPIOA,3)

//#define SUSB				SDU1
//#define SDA					SD1

#define SD_OUTPUT	SD1
#define SD_SERIAL	SD2
